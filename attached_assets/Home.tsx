...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className="relative bg-emerald-800 text-white">
        ...
        <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
          ...
          <div className="mt-8 flex space-x-4">
            <button className="bg-white text-emerald-800 px-6 py-3 rounded-md hover:bg-gray-100 transition-colors">
              En savoir plus
            </button>
            <button className="border-2 border-white text-white px-6 py-3 rounded-md hover:bg-white hover:text-emerald-800 transition-colors">
              Nous rejoindre
            </button>
          </div>
        </div>
      ...
      {/* Partners Section with Circular Auto-scroll */}
      <div className="bg-emerald-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative overflow-hidden">
            <div className="flex space-x-8 partners-scroll">
              {[...partners, ...partners, ...partners].map((partner, index) => (
                <div 
                  key={index} 
                  className="flex-none w-48 h-32 bg-white p-4 rounded-lg shadow-md transition-all duration-300 hover:shadow-lg cursor-pointer"
                >
